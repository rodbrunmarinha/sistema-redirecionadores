...
import { ChevronRight, Settings2, Plus, Info } from "lucide-react";
import { getExtraServices } from "./_actions/extraServices";
import { ExtraServicesClient } from "./ExtraServicesClient";

export default async function ExtraServicesPage(props: { params: Promise<{ subdomain: string }> }) {
  ...
  const extraServices = await getExtraServices(tenant.id);
      ...
      <div className="bg-zinc-900 border-b border-zinc-800 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <nav className="flex items-center gap-2 text-sm mb-4" aria-label="Breadcrumb">
            ...
            <span className="text-zinc-100 font-medium">Serviços Extras</span>
          </nav>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Serviços Extras</h1>
                <p className="text-zinc-400 text-sm mt-1">
                  Gerencie serviços adicionais que os clientes podem contratar
                </p>
              </div>
            </div>
