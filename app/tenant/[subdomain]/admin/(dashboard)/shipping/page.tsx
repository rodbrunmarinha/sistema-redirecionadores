...
import { ChevronRight, Truck, Plus } from "lucide-react";
import { getShippingTypes } from "./_actions/shipping";
import { ShippingListClient } from "./ShippingListClient";

export default async function ShippingPage(props: { params: Promise<{ subdomain: string }> }) {
  ...
  const shippingTypes = await getShippingTypes(tenant.id);
      ...
      <div className="bg-zinc-900 border-b border-zinc-800 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <nav className="flex items-center gap-2 text-sm mb-4" aria-label="Breadcrumb">
            ...
            <span className="text-zinc-100 font-medium">Tabela de Frete</span>
          </nav>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Tabela de Frete</h1>
                <p className="text-zinc-400 text-sm mt-1">
                  Gerencie tipos de frete e suas faixas de peso.
                </p>
              </div>
            </div>
