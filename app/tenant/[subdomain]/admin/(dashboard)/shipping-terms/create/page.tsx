...
import { ShippingTermsCreateClient } from "./ShippingTermsCreateClient";

export default async function ShippingTermsCreatePage(props: { params: Promise<{ subdomain: string }> }) {
    ...
    <div className="min-h-screen bg-zinc-950 -m-8">
      <div className="bg-zinc-900 border-b border-zinc-800 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Novo Termo de Envio</h1>
              <p className="text-zinc-400 text-sm mt-1">
                Crie um termo para o aceite dos seus clientes
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-6 sm:py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ShippingTermsCreateClient subdomain={subdomain} />
        </div>
      </div>
    </div>
  );
