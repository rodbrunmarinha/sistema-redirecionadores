...
import { getDocuments } from "./_actions/documents";
import { DocumentsClient } from "./DocumentsClient";

export default async function DocumentsPage(props: { params: Promise<{ subdomain: string }> }) {
      ...
      <div className="bg-zinc-900 border-b border-zinc-800 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <nav className="flex items-center gap-2 text-sm mb-4" aria-label="Breadcrumb">
            ...
            <span className="text-zinc-100 font-medium">Documentos para Clientes</span>
          </nav>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Documentos para Clientes</h1>
              <p className="text-zinc-400 text-sm mt-1">
                Manuais, guias e tabelas em PDF que seus clientes veem no painel e no aplicativo
              </p>
            </div>
          </div>
        </div>
