...
CREATE TYPE public.assisted_purchase_status AS ENUM (
    'PENDING_PAYMENT',         -- Aguardando Pagamento (pelo cliente no inicio)
    'PAID_PENDING_PURCHASE',   -- Pago, Aguardando Compra (Lojista)
    'PENDING_EXTRA_PAYMENT',   -- Aguardando Pagamento Extra (Cliente)
    'PURCHASED',               -- Comprado (Lojista)
    'OUT_OF_STOCK',            -- Esgotado / Cancelado pelo lojista (Estorno efetuado)
    'CANCELLED'                -- Cancelado pelo cliente antes da compra (Estorno)
);
